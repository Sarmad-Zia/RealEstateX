export const styles = {
  ...
  navbarBase: "fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out font-inter overflow-hidden",
  ...
  navBtnOutlineFull: "border-2 border-sand text-ink bg-transparent px-5 py-2 rounded-lg hover:border-forest hover:bg-cream transition-all duration-200 text-sm font-semibold border-mint! ",
