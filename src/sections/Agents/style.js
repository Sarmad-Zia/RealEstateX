export const styles = {
  ...
  aiIconBox: "w-[70px] h-[70px] bg-grad-icon text-forest flex items-center justify-center rounded-2xl mb-8 transition-transform duration-300 group-hover:scale-105",
