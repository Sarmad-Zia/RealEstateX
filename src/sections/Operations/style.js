export const styles = {
  py5: "py-24 px-6",
  bgWhite: "bg-paper",
  sectionHeader: "text-center mb-16 max-w-2xl mx-auto",
  sectionTitle: "text-3xl md:text-4xl font-extrabold font-poppins text-ink tracking-tight",
  sectionDesc: "text-body-text mt-4 text-base md:text-lg leading-relaxed",


  opsGrid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8",
