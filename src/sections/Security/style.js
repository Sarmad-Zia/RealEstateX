export const styles = {
  py5: "py-24 px-6",
  bgLight: "bg-sand",
  sectionTag: "inline-block px-4 py-1.5 bg-paper text-forest font-bold text-xs uppercase tracking-wider rounded-full mb-6",
  heading: "text-3xl md:text-4xl font-extrabold font-poppins mb-6 text-ink",
  ...
  specsTitleRow: "flex items-center gap-2 mb-6",
  specsTitle: "text-xl font-bold font-poppins text-ink",
  specsList: "space-y-4",
  specsItem: "flex items-center text-body-text font-medium text-base",
  specsCheck: "text-mint mr-4 shrink-0",
};